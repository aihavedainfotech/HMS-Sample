...
class BillPredictor:
    def __init__(self, data_path='/home/ubuntu/Downloads/kimi_clone/bill_prediction/hospital_bill_data(1).csv'):
    ...
    def _initialize_model(self):
        try:
            ...
            if not os.path.exists(self.data_path):
                print(f"[AI Bill] Error: Dataset not found at {self.data_path}")
                return
