...
const doctorDepartments = [
  ...
  { value: 'GENS', label: 'General Surgery' },
  { value: 'ENT', label: 'ENT' },
  { value: 'OPTH', label: 'Ophthalmology' },
  { value: 'DERM', label: 'Dermatology' },
  { value: 'PSY', label: 'Psychiatry' },
...
export default function StaffLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await login(staffId.toUpperCase(), password, department);
    if (success) {
              ...
              <div className="mt-6">
                ...
                <div className="mt-4 grid grid-cols-2 gap-2 text-xs text-muted-foreground bg-gray-50 p-3 rounded-lg border border-gray-100">
                  ...
                  <div className="space-y-1">
                    ...
                    <p><span className="font-medium text-gray-700">Nurse:</span> NRS001 / password123</p>
                  </div>
                </div>
              </div>
            </CardContent>
