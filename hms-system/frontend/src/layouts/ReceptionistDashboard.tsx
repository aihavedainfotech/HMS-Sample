...
import ReceptionistHome from '@/pages/dashboard/ReceptionistHome';
...
export default function ReceptionistDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-16 h-[calc(100vh-4rem)] bg-white border-r transition-all duration-300 z-40 ${sidebarOpen ? 'w-64' : 'w-0 overflow-hidden'
          }`}
      >
        <nav className="p-4">
          <div className="mb-4 px-2">
            <p className="text-xs font-medium text-muted-foreground uppercase">Receptionist</p>
